...
Run `deploy4j accessory boot <accessory>` to boot an accessory. See `deploy4j accessory --help` for more information.

## Configuring accessories

First define the accessory in the `accessories` block. Below is an example accessory configuration.
...
accessories:
  mysql:
    ...
    # See deploy4j docs env for more information
    env:
      ...
