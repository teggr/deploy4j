...
2. Push env files to the hosts (you may need to run [deploy4j envify](/commands/envify/) to generate .env first)
3. Boot all accessories
4. Deploy the app (see [deploy4j deploy](/commands/deploy/))