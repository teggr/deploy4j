...
public class Traefik {
  ...
  private static final String CONTAINER_PORT = "80";
  ...
  public Traefik(Configuration config) {
    this.config = config;
    this.traefikConfig = config.rawConfig().traefik();
  }

  public boolean publish() {
    return traefikConfig.publish() != false;
  }
  ...
  public Env env() {
    return new Env( traefikConfig.env() ); // TODO: secrets and context
  }
  ...
  public Map<String, String> args() {
    ...
    args.putAll(traefikConfig.args());
    return args;
  }
