...
@CommandLine.Command(
  ...
  subcommands = {
    ...
    AccessoryCommand.UploadCommand.class,
    AccessoryCommand.DirectoriesCommand.class,
    AccessoryCommand.RebootCommand.class,
    AccessoryCommand.StartCommand.class,
    AccessoryCommand.StopCommand.class,
    AccessoryCommand.RestartCommand.class,
    AccessoryCommand.DetailsCommand.class,
    AccessoryCommand.ExecCommand.class,
    AccessoryCommand.LogsCommand.class,
    AccessoryCommand.RemoveCommand.class,
  })
public class AccessoryCommand {
  ...
  public static class UploadCommand extends BaseCommand {
  ...
  public static class DirectoriesCommand extends BaseCommand {
  ...
  public static class RemoveServiceDirectoryCommand extends BaseCommand {
